...
<div class="main-container row d-flex">
    ...
    <div class="edit col-md-5">
        <div id="contact-create-container" class="col-md-6">
            ...
            <form action="/contacts" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="zipcode" name="zipcode" placeholder="CEP (apenas números)">
                    ...
                    <input type="text" class="form-control" id="house_number" name="house_number" placeholder="Número">
                </div>
                <div class="form-group">
                    <label for="name">Nota: </label>
                    <input type="text" class="form-control" id="name" placeholder="Nota">
                </div>
